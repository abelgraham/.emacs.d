...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (cider clojure-mode chocolate-theme doom-modeline nov org-pomodoro vue-mode markdown-mode slime rust-mode all-the-icons parrot rainbow-delimiters emojify yaml-mode wc-mode python-mode htmlize org-plus-contrib dired-filter dired-icon dired-launch dashboard brief org)))
 '(tool-bar-mode nil))
(custom-set-faces
...
(global-set-key (kbd "H-j")
		(lambda ()
		  ...
		  (if (string-equal (message "%s" major-mode) "cider-repl-mode")
