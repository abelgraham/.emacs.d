...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (evil haskell-mode jinja2-mode cider rust-mode chocolate-theme doom-modeline markdown-mode slime all-the-icons parrot rainbow-delimiters emojify yaml-mode wc-mode python-mode htmlize org-plus-contrib dired-filter dired-icon dired-launch dashboard brief org)))
 '(tool-bar-mode nil))
(custom-set-faces
