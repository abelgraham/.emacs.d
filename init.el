...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (markdown-mode slime rust-mode all-the-icons doom-modeline parrot nyan-mode rainbow-delimiters emojify yaml-mode wc-mode python-mode htmlize org-plus-contrib dired-filter dired-icon dired-launch dashboard doom-themes brief org)))
 '(tool-bar-mode nil))
(custom-set-faces
