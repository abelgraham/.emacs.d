...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (org-pomodoro vue-mode markdown-mode slime rust-mode all-the-icons doom-modeline parrot rainbow-delimiters emojify yaml-mode wc-mode python-mode htmlize org-plus-contrib dired-filter dired-icon dired-launch dashboard doom-themes brief org)))
 '(tool-bar-mode nil))
(custom-set-faces
