...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (cider elixir-mode rainbow-delimiters emojify yaml-mode rust-mode wc-mode python-mode powerline htmlize org-plus-contrib dired-filter dired-icon dired-launch dashboard doom-themes brief org)))
 '(tool-bar-mode nil))
(custom-set-faces
