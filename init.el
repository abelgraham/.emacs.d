...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (jinja2-mode rust-mode chocolate-theme doom-modeline nov org-pomodoro vue-mode markdown-mode slime all-the-icons parrot rainbow-delimiters emojify yaml-mode wc-mode python-mode htmlize org-plus-contrib dired-filter dired-icon dired-launch dashboard brief org)))
 '(tool-bar-mode nil))
(custom-set-faces
